# Linux runtime sub-build configuration for libcxx-pgo.

set(_build "$ENV{CLANGUP_BUILD}")

set(_cxx_flags
    "-nostdinc++ -isystem ${_build}/include/$ENV{CLANGUP_TARGET_TRIPLE}/c++/v1 -isystem ${_build}/include/c++/v1 -nostdlib++")
set(_linker_flags
